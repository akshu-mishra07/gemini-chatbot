...
def main():
    ...
    with open(transcript_path, "r", encoding="utf-8") as f:
        for idx, line in enumerate(f):
            ...
            # Verify it is exactly app.py's file path header
            # File Path: `file:///c:/Users/ACER/OneDrive/Desktop/gemini-chatbot/streamlit-chatbot/app.py`
    ...
    print(f"Total distinct lines found: {len(lines_map)}")
    ...
    out_path = r"c:\Users\ACER\OneDrive\Desktop\gemini-chatbot\streamlit-chatbot\app_perfect.py"
